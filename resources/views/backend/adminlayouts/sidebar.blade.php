...
<div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
    ...
    <div class="flex items-center justify-center mt-8" style="margin-left:-18px">
        ...
        <div class="d-inline-block" style="width:200px; display: flex;">
            <img src="/favicon.ico" style="height:50px; display:inline-block" alt="Pie Dev">
            <span
                class="text-white mx-2 font-semibold font-size-6">{{ __('customer.welcome') }}, {{auth()->guard('admin')->user()->name}}</span>
        </div>
    </div>
    ...
    <nav class="mt-10">
        ...
        <a class="flex items-center mt-4 py-2 px-6 text-gray-300 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
           href="{{route('products.index')}}">
            ...
            <span class="mx-3">{{ __('customer.orders.3') }}</span>
        </a>
        <a class="flex items-center mt-4 py-2 px-6 text-gray-300 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
           href="{{route('brands.index')}}">
            ...
            <span class="mx-3">{{ __('home.features.10') }}</span>
        </a>
        <a class="flex items-center mt-4 py-2 px-6 text-gray-300 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
           href="{{route('attributes.index')}}">
            ...
            <span class="mx-3">{{ __('customer.orders.8') }}</span>
        </a>
        <a class="flex items-center mt-4 py-2 px-6 text-gray-300 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
           href="{{route('categories.index')}}">
            ...
            <span class="mx-3">{{ __('app.categories') }}</span>
        </a>
        <a class="flex items-center mt-4 py-2 px-6 text-gray-300 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
           href="{{route('adminOrders.index')}}">
            ...
            <span class="mx-3">{{ __('customer.orders.9') }}</span>
        </a>
...
{{--        </a>--}}
        ...
        <a class="flex items-center mt-4 py-2 px-6 text-gray-300 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
           href="{{route('logActivity')}}">
            ...
            <span class="mx-3">{{ __('home.users_activities') }}</span>
        </a>
        <a class="flex items-center mt-4 py-2 px-6 text-gray-300 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
           href="{{route('visitorActivity')}}">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 24 24"><title>heart-rate-monitor</title><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="M3 5a1 1 0 0 1 1-1h16a1 1 0 0 1 1 1v10a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1zm4 15h10m-8-4v4m6-4v4"/><path d="M7 10h2l2 3l2-6l1 3h3"/></g></svg>
            <span class="mx-3">Visite giornaliere</span>
        </a>
        @if(auth()->guard('admin')->user()->id == 1)
            ...
            <a class="flex items-center mt-4 py-2 px-6 text-gray-300 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
               href="{{route('AdminLogActivity')}}">
                ...
                <span class="mx-3">{{ __('home.admin_activities') }}</span>
            </a>
        @endif
        <a class="flex items-center mt-4 py-2 px-6 text-gray-300 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100"
           href="{{ route('logout') }}"
