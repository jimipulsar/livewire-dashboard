                            ...
                            @foreach($uniqueCategories as $parentCategory)
                                <div class="chek-form">
                                    <div class="custome-checkbox">
                                        ...
                                        <input wire:click="$emit('filterByCategory', {{ $parentCategory->id }})"
                                               wire:ref="search-box" class="form-check-input" type="checkbox"
                                               name="checkbox"
                                               id="differentaddress{{ $parentCategory->id }}" data-id="{{ $parentCategory->id }}">
...
@section('extraJs')
    ...
    <script type="module" src="/assets/js/sliderCategory.js"></script>
@endsection
