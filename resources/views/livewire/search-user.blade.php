<div class="flex flex-col mt-3">
    <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
            ...
            <table class="min-w-full">
                ...
                <tr>
                    ...
                    <th style="width:200px; cursor:pointer" wire:click.prevent="sortBy('billing_city')"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                             stroke="{{ $sortColumnName === 'billing_city' && $sortDirection === 'desc' ? 'black' : 'currentColor' }}"
                             class="w-3 h-3 inline-block">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                  d="M15.75 17.25L12 21m0 0l-3.75-3.75M12 21V3"/>
                        </svg>
        ...
        <div class="d-flex justify-content-center mt-5 mb-5">
            @if(isset($query))
                {{ $users->appends($query)->onEachSide(1)->links() }}
            @else
                {{ $users->onEachSide(1)->links('vendor.livewire.tailwind') }}
            @endif
