...
@section('body')
    ...
    <nav class="text-sm font-medium text-on-surface dark:text-on-surface-dark mt-3" aria-label="breadcrumb">
        <ol class="flex flex-wrap items-center gap-1">
            ...
            <li class="flex items-center gap-1">
                <a href="{{route('products.index')}}" class="hover:text-on-surface-strong dark:hover:text-on-surface-dark-strong">Prodotti</a>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" aria-hidden="true" stroke-width="2" stroke="currentColor" class="size-4">
                    <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5" />
                </svg>
            </li>
                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        ...
                        <div class="grid grid-cols-6 gap-6 py-3">
                            ...
                            <div class="col-span-1 sm:col-span-1">
                                ...
                                <input type="number" name="stock_qty" id="stock_qty" value=""
                            ...
                            <div class="col-span-1 sm:col-span-1">
                                ...
                                <select
                                    ...
                                    @foreach ($mainAttributes as $attr)
                                        <option value="{{$attr->id }}">{{ ucFirst($attribute->name) }}
                                        </option>
                                    @endforeach
                                </select>
                                @if($errors->has('attributes'))
                            ...
                            <div class="col-span-1 sm:col-span-1">
                                ...
                                <select
                                    ...
                                    @foreach ($mainBrands as $br)
                                        <option value="{{$br->id }}">{{ ucFirst($br->name) }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-span-1 sm:col-span-1">
                                ...
                                <input type="number" name="base_height" id="base_height" value=""
                                       class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" style="line-height:1.3em !important;">
                            </div>
                            <div class="col-span-1 sm:col-span-1">
                                ...
                                <input type="number" name="base_width" id="base_width" value=""
                                       class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" style="line-height:1.3em !important;">
                            </div>
                            <div class="col-span-1 sm:col-span-1">
                                ...
                                <input type="number" name="base_depth" id="base_depth" value=""
                                       class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" style="line-height:1.3em !important;">
                            </div>
                            <div class="col-span-1 sm:col-span-1">
                                ...
                                <input type="number" name="base_weight" id="base_weight" value=""
                                       class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" style="line-height:1.3em !important;">
                            </div>
                            <div class="col-span-2 sm:col-span-2">
