...
//        ]);
    ...
    public function update( Request $request, $id)
    {
        ...
        return redirect()->route('attributes.index')->with(array('attribute' => $attribute))->with('success', 'Attributo modificata con successo!');
    }
    ...
    public function searchAttribute()
    {
        ...
        if (count($attributes) > 0) {
            ...
            return redirect()->route('attributes.index')->with('danger', 'Corrispondenza non trovata');
        }
    }
